      ...
      <div class="kc-doc-stage">
        <div class="kc-doc-surface">
          ...
          <div class="kc-empty-state" id="kc-empty-state" hidden>
            <strong>Start writing or press / to insert a block</strong>
            <span>Use Components, the Insert ribbon, or the contextual + control.</span>
            <button type="button" class="kc-head-btn" id="kc-empty-insert">Insert a component</button>
          </div>
        </div>
      </div>
      <?php endif; ?>
