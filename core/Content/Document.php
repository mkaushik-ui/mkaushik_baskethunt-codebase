...
final class Document
{
    ...
    private static function looksLikeEditorJs(array $raw): bool
    {
        ...
        return in_array($type, ['header', 'delimiter', 'linkTool', 'linkCard', 'attaches'], true);
    }
    ...
    private static function toEditorJsBlock(array $block): array
    {
        ...
        $editorType = match ($type) {
            ...
            'divider' => 'delimiter',
            'list' => 'list',
            // Keep block tool name distinct from Editor.js built-in Link inline tool.
            'link' => 'linkCard',
            default => $type,
        };
